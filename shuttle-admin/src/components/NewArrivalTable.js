...
import UpdateNewArrivalModal from './UpdateNewArrivalModal';

function NewArrivalTable({ products }) {
  const toast = useToast();
  const { fetchProducts, deleteProduct } = useNewArrivalContext();
                ...
                <Tr key={index}>
                  ...
                  <Td>
                    <Menu>
                      ...
                      <MenuList>
                        <Link to={`/newArrival/${id}`}>
                          <MenuItem>View</MenuItem>
                        </Link>
                        <MenuItem>
                          <UpdateNewArrivalModal id={id} />
                        </MenuItem>
