...
export const NewArrivalProvider = ({ children }) => {
  ...
  const fetchProducts = async () => {
    ...
    try {
      const response = await axios.get(newArrival_url);
  ...
  const fetchSingleProduct = async (id) => {
    ...
    try {
      const response = await axios.get(`${single_arrival_url}${id}`);
      const { data } = response.data;
  ...
  const deleteProduct = async (id) => {
    try {
      const response = await axios.delete(`${update_newArrival_url}${id}`);
  ...
  const createNewProduct = async (product) => {
    try {
      const response = await axios.post(create_newArrival, product);
  ...
  const updateProduct = async (id, product) => {
    try {
      const response = await axios.put(`${update_newArrival_url}${id}`, product);
      const { success, message } = response.data;
      // fetchProducts();
      return { success, message };
    } catch (error) {
  ...
  const deleteReview = async (productId, reviewId) => {
    try {
      const response = await axios.delete(`${delete_newArrival}${productId}`, {
        data: {
          reviewId,
        },
      });
...
export const useNewArrivalContext = () => {
