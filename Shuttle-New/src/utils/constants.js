...
export const create_order_url = `http://localhost:5000/api/orders/new`;
export const get_order_url = `http://localhost:5000/api/orders`;
export const payment_url = `http://localhost:5000/api/payment/create-payment-intent`;
